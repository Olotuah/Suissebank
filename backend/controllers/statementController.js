...
export const generateStatementPdf = async (req, res) => {
  ...
  $or: [
    ...
    res.setHeader(
      "Content-Disposition",
      `attachment; filename="Swissbankasi-statement-${from}-${to}.pdf"`
    );
    ...
    doc.fillColor("#ffffff").fontSize(24).text("SwissBankasi", 40, 32);
    ...
    doc
      ...
      .fillColor("#64748b")
      .text(
        "This statement is system-generated by SwissBankasi and reflects recorded transactions within the selected period.",
        40,
        footerY,
